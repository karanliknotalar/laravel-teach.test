...
Route::group(["prefix" => "/sepet"], function () {
    ...
    Route::get("/odeme", [CartController::class, "cart"])->name("cart.order");
    Route::post("/odeme-tamamla", [CartController::class, "orderComplete"])->name("cart.order-complete");
});
...
Route::group(["prefix" => "admin", "middleware" => ["admin.dashboard.shared", "auth", "isAdmin"]], function () {
    ...
    Route::resource("product-quantity", "Admin\ProductQuantityController")->except("update", "show");
