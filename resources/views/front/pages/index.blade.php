...
@section("content")
    {{--    <div class="site-blocks-cover" style="background-image: url({{ asset($slider->image ?? "images/hero_1.jpg") }});"--}}
    {{--         data-aos="fade">--}}
    ...
    {{--                        <h1 class="mb-2">{{ $slider->name ?? "empty" }}</h1>--}}
    {{--                        <div class="intro-text text-center text-md-left">--}}
    {{--                            <p class="mb-4">{{ $slider->content ?? "empty" }} </p>--}}
    {{--                            <p>--}}
    {{--                                <a href="{{ url($slider["shop_url"]) ?? "empty" }}" class="btn btn-sm btn-primary">Alışverişe--}}
    {{--                                    Başla</a>--}}
    {{--                            </p>--}}
    {{--                        </div>--}}
    {{--                </div>--}}
